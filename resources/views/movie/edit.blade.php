...
<div class="flex flex-col items-center">
  <h2 class="text-black text-3xl font-medium ">Update Movie</h2>
  <form enctype="multipart/form-data" action="{{ route('movie.update', $movie->id) }}" class="w-1/3 mt-16"
    method="POST">
    @csrf
    @method('PATCH')
    <div class="mb-6">
      ...
      <input type="text" name="name" id="name"
        ...
        placeholder="The Avengers" value="{{ $movie->name }}" required>
    </div>
    <div class="mb-6">
      ...
      <input type="number" min="1" max="999" name="minute_length" id="minute_length"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        placeholder="153" value="{{ $movie->minute_length }}" required>
    </div>
    <div class="mb-6">

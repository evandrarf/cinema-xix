...
<div class="flex flex-col items-center">
  <h2 class="text-black text-3xl font-medium ">Create Studio</h2>
  <form action="{{ route('studio.store') }}" class="w-1/3 mt-16" method="POST">
    @csrf
    <div class="mb-6">
      ...
      <input type="text" name="name" id="name"
        ...
        placeholder="Cinepolis" required>
    </div>
    <div class="mb-6">
